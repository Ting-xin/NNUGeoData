<template style="height: 100%;">
  <FileCatalog :visible="fileVisible" @changeVisible="changeFileVisible" />
  <div>
    <el-container>
      <!-- <el-header height="5%">
...
const fileDialog = () => {
  ...
  const changeFileVisible = () => {
    console.log("changeFileVisible");
    fileVisible.value = !fileVisible.value;
    console.log("fileVisible: ", fileVisible.value);
  };
  return {
    fileVisible,
    changeFileVisible,
...
export default {
  ...
  setup() {
    const { fileVisible, changeFileVisible } = fileDialog();
